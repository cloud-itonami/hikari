...
(defn collection
  [name]
  (str "com.etzhayyim.hikari." name))

(def cell-specs {
  :solar_pv_install {:legacy-cell "solar-pv-install"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "solar_pv_install")]
     :required-gates common-gates
     :trigger "manifest cell solar_pv_install"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :storage_battery {:legacy-cell "storage-battery"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "storage_battery")]
     :required-gates common-gates
     :trigger "manifest cell storage_battery"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :grid_edge {:legacy-cell "grid-edge"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "grid_edge")]
     :required-gates common-gates
     :trigger "manifest cell grid_edge"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :geothermal_micro {:legacy-cell "geothermal-micro"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "geothermal_micro")]
     :required-gates common-gates
     :trigger "manifest cell geothermal_micro"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :consumption_audit {:legacy-cell "consumption-audit"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "consumption_audit")]
     :required-gates common-gates
     :trigger "manifest cell consumption_audit"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
